<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <div class="row">
                        <div class="col-md-6" id="barInfoPOI">
                            ...
                            <g:form url="[resource:poiInstance, action:'save']" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateLatng();">
    ...
    <g:javascript>
        ...
        $(function(){
            ...
            messageSuccessFulCreation("POI ajouté", "Impossible d'ajouté ce POI");
        });
